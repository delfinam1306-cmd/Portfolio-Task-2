...
<section class="about" id="about">
  ...
  <div class="image">
            <img class="tilt" src="images/sec.jpg" alt="">
        </div>

  <div class="content">
            <h3> my name is <span>Delfina Masarallo M</span> </h3>
            <p class="info">I'm currently pursuing bachelor degree in computer science engineering at KVCET, Chengalpattu. I have basic knowledge of programming languages like HTML, CSS, JavaScript,Reactjs,Java. Also I have ability to learn new things and believe in creativity. Passion for innovation and visiting new places.</p>
            <div class="box-container">
                <div class="box">
                    <p> <span> Full Name: </span>Delfina Masarallo M</p>
                    <p> <span> Age: </span> 19 </p>
                    <p> <span> College: </span> Karpaga Vinayaga college of engineering and technology, Chengalpattu</p>

   <p> <span> Passion: </span> Craft work, Listening music
  ...
  <p> <span> Freelance : </span> available </p>
                ...
                <div class="box">
                    <p> <span> Language : </span> Tamil / English / Telugu</p>
                    <p> <span> Phone : </span> 8940737966 </p>
                    <p> <span> Email : </span> delfinam1306@gmail.com </p>
...
<div class="box-container">
  ...
  <div class="box tilt">
            ...
            <p>Email marketing is a form of marketing that can make the customers on your email list aware of new products, discounts, and other services.</p>
        </div>

   <div class="box tilt">
            <i class="fas fa-mobile"></i>
            <h3>Responsive designs</h3>
            <p>Responsive web design (RWD) is a web development approach that creates dynamic changes to the appearance of a website.</p>
        </div>
...
<h1 class="heading"> <span> my </span> blogs </h1>
  ...
  <div class="box tilt">
            <img src="images/blog3.svg" alt="">
            <h3> Coursera </h3>
            <p>Coursera Inc. is an American massive open online course provider founded in 2012 by Stanford University computer science professors Andrew Ng and Daphne Koller. Coursera works with universities and other organizations to offer online courses, certifications, and degrees in a variety of subjects. </p>
            <a href="https://www.coursera.org/in" class="btn">learn more</a>
        </div>

  <div class="box tilt">
            <img src="images/blog2.jpg" alt="">
            <h3> Udemy </h3>
            <p>Udemy, Inc. is an American massive open online course provider aimed at professional adults and students. It was founded in May 2010 by Eren Bali, Gagan Biyani, and Oktay Caglar. As of June of 2021, the platform has more than 44 million students, 183,000 courses and 65,000 instructors teaching courses in 75 languages.</p>
            <a href="https://www.udemy.com/" class="btn">learn more</a>
        </div>
...
<section class="teams" id="teams">
    <div class="max-width">
        ...
        <div class="carousel owl-carousel">
            <div class="card">
                <div class="box">
                    <img src="images/partu.jpeg" alt="">
                    <div class="text"><b>Pratidnya Shikhare</b></div>
                    <h1>Marathwada Mitra Mandal Institute Of Technology Lohgaon Pune</h1>
                </div>
            </div>
            <div class="card">
                <div class="box">
                    <img src="images/vaishu.jpeg" alt="">
                    <div class="text"><b>Vaishnavi Harale</b></div>
                    <h1>Pune District Education Association College Of Engineering Pune </h1>
                </div>
            </div>
            <div class="card">
                <div class="box">
...
<section class="contact" id="contact">
  ...
  <div class="image">
   ...
   <form action="https://formspree.io/f/xwkykooe" method="post">
...
var typed = new Typed('.typing-text', {
    strings : ['Computer Engineer', 'Web Designer', 'Front End Developer','Web Developer','Computer Engineer'],
    loop : true,
    typeSpeed : 130
});
